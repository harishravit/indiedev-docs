...
- TypeScript is a compiler-based language built on top of JavaScript that adds static typing.Because
  JavaScript is a dynamically typed language, which means it automatically assigns a type based on the value.
